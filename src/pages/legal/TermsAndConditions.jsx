...
const TermsAndConditions = () => {
  return (
    <div className="legal-page container animate-fade-in py-16">
      ...
      <p className="text-gray-500 mb-8">Welcome to FIXIVA - One App. Every Solution. Everything Your Home Needs.</p>
      ...
      <div className="legal-content space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>Contractors operating through FIXIVA must hold any necessary local licenses or permits required for large-scale jobs. Contractors are fully responsible for their crew's conduct and safety on the job site. Quality of work and customer satisfaction are paramount.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-3 text-gray-900">4. Booking Terms</h2>
          <p>By placing a booking through our platform, you agree to the Base Price and Fixiva Convenience Fee shown at checkout. Additional parts, materials, or expanded scope of work discussed on-site will incur extra charges agreed upon directly with the professional.</p>
        </section>
        ...
        <section>
          ...
          <p>FIXIVA currently operates in select cities. We do not guarantee the availability of all services in all regions at all times. Service fulfillment is subject to the availability of verified professionals in your local area.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-3 text-gray-900">7. Platform Liability Disclaimer</h2>
          <p>FIXIVA acts solely as a marketplace connecting customers with independent professionals. While we thoroughly verify our partners, FIXIVA is not liable for any direct, indirect, or consequential damages, losses, or injuries arising from the execution of services.</p>
        </section>
        ...
        <section>
          ...
          <p>FIXIVA reserves the right to suspend or terminate accounts (Customer, Worker, or Contractor) without prior notice if they violate these Terms and Conditions, receive consistently poor Trust Scores, or engage in fraudulent activities.</p>
        </section>
